              ...
              <table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                  <tr>
                    ...
                    <td align="right">
                      <p style="text-align:right;color:#808080;margin:0 0 5px;font-size:16px;line-height:1.2;font-family:Helvetica,sans-serif">For Support Related To Upcoming Rentals</p>
              ...
              <table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                  <tr>
                    <td width="20"></td>
                    <td>
                      <p style="color:#003764;margin:0;font-size:18px;line-height:1;font-weight:bold;display:inline-block;font-family:Helvetica,sans-serif">Dear <a style="color:#fac316;" href="mailto: target=" _blank">{{$data2['email']}}</a> , </p>
                    </td>
                    <td width="20"></td>
                  </tr>
                </tbody>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                  ...
                  <tr>
                    <td width="20"></td>
                    <td>
                      <p style="color:#fff;font-size:18px;line-height:1;font-family:Helvetica,sans-serif">Reservation Number <span style="color:#fac316;font-size:18px;line-height:1;font-weight:bold;border-bottom:1px solid #003764;display:inline-block;font-family:Trebuchet MS,sans-serif">DIR#{{$data2['invoice_no']}}</span>
                      </p>
                    </td>
                    <td align="right">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:normal;font-family:Helvetica,sans-serif">{{$data2['first_name']}}
                              </p>
                            </td>
                            <td>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:normal;font-family:Helvetica,sans-serif">
                                <a href="mailto:abc@gmail.com" target="_blank">{{$data2['email']}}</a>
                              </p>
                            </td>
                            <td></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:normal;font-family:Helvetica,sans-serif">{{$data2['phone_number']}}</p>
                            </td>
                            <td>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:normal;font-family:Helvetica,sans-serif">{{$data2['country']}}</p>
                            </td>
                            <td></td>
                          </tr>
                        </tbody>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:bold;font-family:Helvetica,sans-serif">{{$data2['pickup_date']}} {{$data2['pickup_time']}}</p>
                            </td>
                            <td></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:bold;font-family:Helvetica,sans-serif">{{$data2['pick_up']}}</p>
                            </td>
                            <td></td>
                          </tr>
                          <tr>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:bold;font-family:Helvetica,sans-serif">{{$data2['return_date']}} {{$data2['pickup_time']}}</p>
                            </td>
                            <td></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:bold;font-family:Helvetica,sans-serif">{{$data2['return_pickup']}}</p>
                            </td>
                            <td></td>
                          </tr>
                          <tr>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                          <tr>
                            ...
                            <td align="right">
                              <p style="margin:0;font-size:18px;line-height:1;font-weight:bold;display:inline-block;font-family:Trebuchet MS,sans-serif">{{$data2['days']}} Day(s) Days &nbsp;</p>
                            </td>
                            <td width="10"></td>
                          </tr>
                        </tbody>
