              ...
              <table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                  <tr>
                    <td width="20"></td>
                    <td>
                      <p style="color:#003764;margin:0;font-size:18px;line-height:1;font-weight:bold;display:inline-block;font-family:Helvetica,sans-serif">Dear <a style="color:#fac316;" href="mailto: target=" _blank">{{$data['email']}}</a> , </p>
                    </td>
                    <td width="20"></td>
                  </tr>
                </tbody>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:normal;font-family:Helvetica,sans-serif">{{$data['first_name']}}
                              </p>
                            </td>
                            <td>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:normal;font-family:Helvetica,sans-serif">
                                <a href="mailto:abc@gmail.com" target="_blank">{{$data['email']}}</a>
                              </p>
                            </td>
                            <td></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:normal;font-family:Helvetica,sans-serif">{{$data['phone_number']}}</p>
                            </td>
                            <td>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:normal;font-family:Helvetica,sans-serif">{{$data['country']}}</p>
                            </td>
                            <td></td>
                          </tr>
                        </tbody>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <p style="color:#000000;margin:0;font-size:16px;line-height:1;font-weight:normal;font-family:Helvetica,sans-serif">{{$data['car_name']}}</p>
                            </td>
                            <td></td>
                          </tr>
                        </tbody>
