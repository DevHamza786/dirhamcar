            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    Settings
                            ...
                            <a href="{{ url('dashboard/logout') }}" class="dropdown-item has-icon text-danger"> <i
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ url('dashboard') }}">
                            ...
                            <img alt="image" src="{{ asset('assets/admin/image/logo.png') }}" class="header-logo" />                       </a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            <a href="{{ route('admin.index') }}" class="nav-link">
                                <i class="fas fa-car"></i><span>Add Features</span></a>
                        </li>
                        ...
                        <li class="dropdown">
                            <a href="{{ route('admin.index') }}" class="nav-link">
                                <i class="fas fa-car"></i><span>Add Addon</span></a>
                        </li>


                        <li class="dropdown">
                            <a href="{{ route('admin.index') }}" class="nav-link">
                                <i class="fas fa-car"></i><span>Add Blog</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('admin.index') }}" class="nav-link">
                                <i class="fas fa-car"></i><span>Revervation</span></a>
                        </li>
                        <li class="dropdown">
                            <a href="{{ route('admin.index') }}" class="nav-link">
                                <i class="fas fa-car"></i><span>Feedback</span></a>
                        </li>
                        <li class="dropdown">
                            <a href="{{ route('admin.index') }}" class="nav-link">
                                <i class="fas fa-car"></i><span>Contact Query</span></a>
                        </li>
                    </ul>
                </aside>
            </div>
