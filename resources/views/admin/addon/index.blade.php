                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('admin.addon.create') }}" class="btn btn-primary">Add Addon</a>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img style="width: 100px;height: 50px;"
                                                            src="{{ asset('/assets/admin/cars/addon/' . $list->car_image) }}"
                                                            alt="Car Image">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.addon.edit', ['id' => $list->id]) }}"
