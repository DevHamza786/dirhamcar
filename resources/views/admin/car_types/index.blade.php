                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($carTypes as $list)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{-- <img style="width: 100px;height: 50px;" src="{{ asset('storage/assets/admin/cars/' . $list->car_icon) }}"
                                                        alt="Car Icon"> --}}
                                                        <img style="width: 100px;height: 50px;"
                                                            src="{{ asset('/assets/admin/cars/' . $list->car_icon) }}"
                                                            alt="Car Icon">

                                                    </td>
                                                    <td>
                                                        <img style="width: 100px;height: 50px;"
                                                            src="{{ asset('/assets/admin/cars/' . $list->car_image) }}"
                                                            alt="Car Image">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.carType.edit', ['id' => $list->id]) }}"
