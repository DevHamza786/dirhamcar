                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('admin.car.create') }}" class="btn btn-primary">Add Car</a>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($cars as $list)
                                                <tr>
                                                    ...
                                                    <td>{{ $list->year }}</td>
                                                    <td>{{ $list->passager }}</td>
                                                    <td>{{ $list->gear_shift }}</td>
                                                    <td>{{ $list->baggage }}</td>
                                                    <td>{{ $list->door }}</td>
                                                    <td>{{ $list->price_aed }}</td>
                                                    <td>{{ $list->price_usd }}</td>
                                                   
                                                    <td>
                                                     @php
                                         $imageArray = explode(',', $list->car_image);
                                       
                                                    @endphp
                                                    
                                          
                                                        <img style="width: 100px;height: 50px;"
                                                            src="{{ asset('/assets/admin/cars/') }}/{{$imageArray[0]}}"
                                                            alt="Car Image">
                                                    </td>
                                                    ...
                                                    <td style="display: flex;padding: 22px 0px;">
                                                        <a href="{{ route('admin.car.edit', ['id' => $list->id]) }}"
